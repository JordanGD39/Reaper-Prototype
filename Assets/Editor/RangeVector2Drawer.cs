...
namespace Editor
{
    ...
    public sealed class RangeVector2Drawer : PropertyDrawer
    {
            ...
            GUIContent label)
        {
            if (property.propertyType is SerializedPropertyType.Vector2 or SerializedPropertyType.Vector2Int)
            {
                ...
                {
                    value.SetX(EditorGUI.Slider(new (xMin, yPosition, sliderWidth, sliderHeight), "X",
                        property.vector2Value.x, rangeAttribute.MinX, rangeAttribute.MaxX));

                    value.SetY(EditorGUI.Slider(new (yMin, yPosition, sliderWidth, sliderHeight), "Y",
